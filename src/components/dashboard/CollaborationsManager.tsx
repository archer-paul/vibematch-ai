...
const mockCollaborations: Collaboration[] = [
  {
    id: '1',
    sponsor: { name: 'Apple', logo: '/logos/apple.svg' },
  ...
  {
    id: '2',
    sponsor: { name: 'Starbucks', logo: '/logos/starbucks.svg' },
    title: 'Coffee Culture Partnership',
    status: 'pending',
    value: 8000,
    deadline: '2025-03-20',
    progress: 0,
    description: 'Monthly content featuring seasonal drinks and community stories',
    type: 'Long-term Partnership'
  },
  {
    id: '3',
    sponsor: { name: 'Nike', logo: '/logos/nike.svg' },
    title: 'Summer Fitness Challenge',
    status: 'completed',
    value: 6000,
    deadline: '2025-01-30',
    progress: 100,
    description: 'Workout videos featuring Nike training gear',
    type: 'Product Integration'
  },
  {
    id: '4',
    sponsor: { name: 'PlayStation', logo: '/logos/playstation.svg' },
