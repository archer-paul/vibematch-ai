...
export const demoSponsorProfile: Profile = {
  ...
  user_type: 'sponsor',
  email: 'jake.thompson@techbrand.com',
  full_name: 'Jake Thompson',
  display_name: 'TechBrand Marketing',
  avatar_url: '/avatars/avatar7.svg',
  bio: 'Marketing director at TechBrand, specializing in influencer partnerships and digital campaigns. Seeking authentic creators for tech product launches.',
